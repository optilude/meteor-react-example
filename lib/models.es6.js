/* jshint esnext:true */
/* global Meteor, Dependencies, Mongo, Collections, SimpleSchema, Roles */
"use strict";
var { _ }  = Dependencies;
...
var Timestamps = new Mongo.Collection("Timestamps");
...
if(Meteor.isServer) {
    ...
    Meteor.publish("timestamps", function() {
        ...
        return Collections.Timestamps.find();
    });
...
// Expose `Collections.Timestamps` to the outside world

_.extend(Collections, { Timestamps });
